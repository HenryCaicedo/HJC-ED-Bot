...
def help(update, context):
    ...
    fib = f"2. /fib, Busca una subsecuencia que pueda considerarse como una sucesión de Fibonacci, a partir de una secuencia ingresada por el usuario. La secuencia debe consistir de números enteros ordenados de menor a mayor y separados por espacios."
